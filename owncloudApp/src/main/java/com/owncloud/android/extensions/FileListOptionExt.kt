...
fun FileListOption.toTitleStringRes(): Int = when (this) {
    ...
    FileListOption.FAVORITE -> R.string.file_list_empty_title_favorite
}
...
fun FileListOption.toSubtitleStringRes(): Int = when (this) {
    ...
    FileListOption.FAVORITE -> R.string.file_list_empty_subtitle_favorite
}
...
fun FileListOption.toDrawableRes(): Int = when (this) {
    ...
    FileListOption.FAVORITE -> R.drawable.ic_star_black_24dp
}
